...
function Account({ user, setUser }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = isLoginMode ? 'https://hacktour.onrender.com/login' : 'https://hacktour.onrender.com/signup';
      ...
      const signedInUser = { name, profileImage: isLoginMode ? user.profileImage : response.data.user.profileImage };
