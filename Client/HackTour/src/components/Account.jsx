...
function Account({ user, setUser }) {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await axios.post('https://hacktour.onrender.com/login', {
                name,
                password,
            });
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-green-300 via-purple-500 to-purple-600">
            ...
            {user ? (
                ...
                <form onSubmit={isLogin ? handleLogin : handleSubmit} className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
                    <div className="mb-4">
                    ...
                    <button type="button" onClick={() => setIsLogin(!isLogin)} className="mt-4 bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded-full transition duration-200">
