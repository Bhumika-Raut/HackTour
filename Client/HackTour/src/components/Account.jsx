...
const Account = ({ setUser: setAppUser }) => {
  ...
  useEffect(() => {
    ...
    if (savedUser) {
      ...
      setUser(parsedUser);
      setAppUser(parsedUser); // Update the user in App state
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isSignup) {
        ...
        setUser(userData);
        setAppUser(userData); // Update the user in App state
  ...
  const handleSignOut = () => {
    setUser(null);
    setAppUser(null); // Update the user in App state
